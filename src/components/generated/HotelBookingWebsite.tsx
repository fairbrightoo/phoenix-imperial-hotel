...
const Logo = () => <div className="flex flex-col items-center mb-12">
    <div className="w-16 h-16 mb-4 relative">
      <svg viewBox="0 0 100 100" className="w-full h-full text-[#C5A265] fill-current">
        {/* Abstract ornamental flower pattern */}
        <path d="M50 0 C60 20 80 20 80 40 C80 60 60 60 50 80 C40 60 20 60 20 40 C20 20 40 20 50 0 Z M50 20 C55 35 65 35 65 45 C65 55 55 55 50 65 C45 55 35 55 35 45 C35 35 45 35 50 20 Z" opacity="0.8" />
        <path d="M50 100 C40 80 20 80 20 60 C20 40 40 40 50 20 C60 40 80 40 80 60 C80 80 60 80 50 100 Z" opacity="0.6" transform="rotate(45 50 50)" />
        <path d="M50 0 C60 20 80 20 80 40 C80 60 60 60 50 80 C40 60 20 60 20 40 C20 20 40 20 50 0 Z" opacity="0.6" transform="rotate(90 50 50)" />
        <circle cx="50" cy="50" r="5" className="fill-[#C5A265]" />
      </svg>
    </div>
    <h1 className="text-3xl font-serif tracking-[0.2em] text-white uppercase font-light">Almaris</h1>
...
const Sidebar = () => {
  ...
  return <div className="hidden md:flex flex-col w-[280px] bg-[#1A1A1A] h-full text-white px-8 py-10 z-20 shadow-2xl relative border-r border-white/5">
      <Logo />
      
      <nav className="flex-1 flex flex-col justify-center space-y-2">
        {MENU_ITEMS.map(item => <div key={item.label}>
            <button onClick={() => item.hasSubmenu && toggleSubmenu(item.label)} className={`flex items-center justify-between w-full py-3 text-sm font-light tracking-wide transition-colors hover:text-[#C5A265] ${openSubmenu === item.label ? 'text-[#C5A265]' : 'text-gray-300'}`}>
      ...
      <AnimatePresence>
        ...
        x: -300
            ...
            <div className="flex justify-between items-center mb-8">
              <span className="text-xl font-serif text-white">ALMARIS</span>
